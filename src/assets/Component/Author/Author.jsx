...
const Author = () => {
    ...
    const { name, profile_image, username, github_username, twitter_username, wensite_url } = blog.user
            ...
            <div className="flex flex-col justify-center  p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                    ...
                    <div className="flex justify-center pt-2 space-x-4 align-center">
                        <NavLink to={`https://github.com/${github_username}`} target='blank' aria-label="GitHub" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
